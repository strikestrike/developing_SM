...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['namespace' => 'SupportTeam',], function () {
        ...
        Route::post('publish_result', 'ExamController@publish_result');
        ...
        Route::post('mystudents', 'StudentRecordController@mystudents');
        ...
        Route::get('meritList', 'PrintOutsController@meritList')->name('meritList');
        Route::get('west', 'PrintOutsController@west')->name('west');
        Route::get('meritList', 'PrintOutsController@meritList')->name('meritList');
        ...
        Route::get('/viewanalysis/{parameter}', 'PageController@show')->name('viewanalysis');
        // my class controller
        Route::get('clear_field',  'StudentRecordController@clear_field');
        ...
        Route::post('bompa_upload', 'BomPAController@bompa_upload')->name('bompa_upload');
        Route::post('teacher_upload', 'TeacherController@teacher_upload')->name('teacher_upload');
        Route::post('staff_upload', 'StaffController@staff_upload')->name('staff_upload');
        // student profile
        ...
        // Route::get('class_index_test', 'ExamController@class_index_test');
        // test excel
        ...
        Route::post('get_stream_stu_marks', 'PrintOutsController@get_stream_stu_marks')->name("get_stream_stu_marks");
        Route::post('getsubjectlists', 'PrintOutsController@getsubjectlists')->name("getsubjectlists");
        Route::post('add_grading_system_id', 'ExamController@add_grading_system_id')->name("add_grading_system_id");
        Route::get('exam_stream_view/{teacher_id}/{myclass_id}/{exam_id}', 'ExamController@exam_stream_view');
        // Route::get('exam_stream_view/{teacher_id}/{myclass_id}/{exam_id}','ExamController@exam_stream_view')->name('exam_stream_view_admin');
        Route::get('exam_form_view/exam_stream_view/{teacher_id}/{myclass_id}/{exam_id}', 'ExamController@exam_stream_view');
        Route::get('exam_form_view/{form_id}', 'ExamController@exam_form_view');
        Route::post('exam_index', 'ExamController@exam_index')->name('exam_index');
        Route::post('stream_publish', 'ExamController@stream_publish')->name('stream_publish');
        Route::post('supervisor_publish_mark', 'ExamController@supervisor_publish_mark')->name('supervisor_publish_mark');
        ...
        Route::post('exam_form_view/class_index', 'ExamController@class_index')->name('class_index');
        Route::post('class_index', 'ExamController@class_index')->name('class_index');
        Route::post('exam_stream_view/grant_access_to_subject_teachers', 'ExamController@grant_access_to_subject_teachers')->name('grant_access_to_subject_teachers');
        ...
        Route::get('exam_manage/publish/{exam_id}/{form_id}', 'ExamController@exam_manage_publish')->name('exam_manage_publish');
        ...
        Route::post('admin_publish', 'ExamController@admin_publish')->name('admin_publish');
        Route::post('unpublish_result', 'ExamController@unpublish_result')->name('unpublish_result');
        ...
        Route::get('exam_class_upload/publish/{class_subject_id}/{exam_id}/{teacher_id}/{subject_id}', 'ExamController@exam_class_upload_publish')->name('exam_class_upload_publish');
        Route::post('exam_class/upload/mark', 'ExamController@exam_class_upload_mark')->name('exam_class_upload_mark');
        Route::post('exam_class/publish/mark', 'ExamController@exam_class_publish_mark')->name('exam_class_publish_mark');
        Route::post('exam_publish_mark', 'ExamController@exam_publish_mark')->name('exam_publish_mark');
        Route::get('exam_class/download', 'ExamController@exam_class_download')->name('exam_class_download');
        Route::get('exam_class/view/{forms_id}/{exams_id}', 'ExamController@exam_class_view')->name('exam_class_view');
        ...
        Route::post('exam_delete_mark', 'ExamController@exam_delete_mark')->name('exam_delete_mark');
    });
