...
<div class="card" style="font-family:icofont">
    ...
    <div class="card-body" style="background-color: #F5F5F5;padding-bottom:580px">
        <ul class="nav nav-tabs nav-tabs-highlight cardpos" style=" transform:translateX(-22px);">
            ...
            <li class="nav-item"><a href="#report-forms" class="nav-link active" data-toggle="tab">Report Forms</a></li>
        ...
        <div class="tab-content " style="background-color: initial;margin:50px 10px">
            ...
            <div class="tab-pane fade show active" id="report-forms">
                <div class="col-12" style="background-color:white;padding:20px 20px 0px 20px">
                    <div class="row">
                        <div class="col-12" style="padding:0px 20px">
                ...
                <div class="col-12" id="report_form_panel" style="font-family: Arial, Helvetica, sans-serif;">
                    ...
                    <div class="container" id='printing_card_panel' style="padding:30px;display:none">
                    </div>
                </div>
            </div>
...
@include('partials.js.class_index1')
@include('partials.js.class_list')
@include('partials.js.group_index')
@include('partials.js.report_forms1')
