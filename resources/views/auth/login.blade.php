                ...
                <div class="collapse navbar-collapse" id="navbarmain">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="{{ url('language/en') }}" id="dropdown02"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-language="en">
                                @if (session('file'))
                                <img src={{ session('file') }} alt="" class="img-fluid" width="15px" />
                                @else
                                <img src='/global_assets/images/landing/GB.svg' alt="" class="img-fluid" width="15px" />
                                @endif
                                ...
                                <span id="lang-title">
                                    ...
                                    <span> <i class="icofont-thin-down"></i></a>
                            <ul class="dropdown-menu" id="dropdown-menu">
                                <li>
                                    <a class="dropdown-item" href="{{ url('language/en') }}" data-language="en">
                                        <img src="/global_assets/images/landing/GB.svg" alt="" class="img-fluid"
                                            width="15px" />
                                        {{-- {{ session('ln') }} --}}
                                        {{-- ENGLISH --}}
                                        {{trans("local.english")}}
                                ...
                                <li>
                                    <a class="dropdown-item" href="{{ url('language/fr') }}" data-language="fr">
                                        <img src="/global_assets/images/landing/FR.svg" alt="" class="img-fluid"
                                            width="15px" />
                                        {{-- FRENCH --}}
                                        {{trans("local.french")}}
                                    </a>
                                ...
                                <li>
                                    <a class="dropdown-item" href="{{url('language/sw')}}" data-language="sw">
                                        <img src="/global_assets/images/landing/TZ.svg" alt="" class="img-fluid"
                                            width="15px" />
                                        {{trans("local.swahili")}}
                                        {{-- SWAHILI --}}
                                    </a>
                                ...
                                <li>
                                    <a class="dropdown-item" href="{{url('language/rw')}}" data-language="rw">
                                        <img src="/global_assets/images/landing/RW.svg" alt="" class="img-fluid"
                                            width="15px" />
                                        {{-- KINYARWANDA --}}
                                        {{trans("local.kiny")}}
                                    </a>
                                ...
                                <li>
                                    <a class="dropdown-item" href="{{url('language/et')}}" data-language="et">
                                        <img src="/global_assets/images/landing/ET.svg" alt="" class="img-fluid"
                                            width="15px" />
                                        {{-- AMHARIC --}}
                                        {{trans("local.amharic")}}
                                    </a>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-xl-4">
                    <div class="block">
                        ...
                        <img src="/global_assets/images/landing/google-play-badge.svg" alt="" class="img-fluid"
                            width="120px" />
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sl-4"></div>
                <div class="col-lg-4 col-md-4 col-xl-4">
                    <div class="card border-success text-start" style="width: 30rem; border-radius: 10px">
                        <div class="card-header">
                            <ul class="nav nav-pills card-header-tabs mb-1">
                                <li class="nav-item">
                                    <button id="login-tab" data-toggle="tab" data-target="#login" role="tab"
                                        class="nav-link action-tabs active" style="margin-right: 4px"
                                        aria-selected="true">
                                        {{ trans("local.login") }}
                                    </button>
                                </li>
                                <li class="nav-item">
                                    <button id="register-tab" data-toggle="tab" data-target="#register" role="tab"
                                        class="nav-link action-tabs" aria-selected="false">
                                        {{ trans("local.signup") }}
                                    </button>
                                </li>
                            </ul>
                        ...
                        <div class="card-body tab-content pt-0">
                            <div id="login" role="tabpanel" aria-labelledby="login-tab"
                                ...
                                <form action="{{ route('login') }}" method="POST">
                                    ...
                                    <div style="margin: 15px 0; background:#F2DEDE; padding: 10px;" id="password-issue"
                                        @if(!$errors->has('password')) class="active-state" @endif>
                                        <h6 style="color: #E0B0B0;"><strong>Authentication Failed</strong></h6>
                                        <h6 style="color:#E0B0B0;">{{$errors->first()}} click <strong>Forgotten
                                                Password</strong> below</h6>
                                    </div>
                                    ...
                                    <div @if ($errors->has('password'))
                                        ...
                                        <div class="col-8">
                                            <div class="row align-items-center">
                                                <img src="/assets/images/school.png" id="logo" alt=""
                                                    class="rounded-circle" width="50" height="50" />
                                                <div class="col-9 ml-2">
                                                    <div class="row">
                                                        <span style="color:grey"
                                                            id="school_name"><strong>{{ $errors->first('identity') }}</strong></span>
                                                    </div>
                                                    <div class="row">
                                                        <span style="color: grey;font-size:12px"
                                                            id="school_title">{{ trans("local.bibironi") }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group" id="password-logo">
                                        <div class="row align-items-center py-2 px-2"
                                            ...
                                            <span style="color: grey">You're yet to set a password for your account,
                                                please enter below your phone number that ends with
                                    ...
                                    <div class="form-group active-state" id="issue-logo">
                                        <div class="row align-items-center py-2 px-2"
                                            style="border:1px solid chocolate;border-radius:10px;">
                                            <span style="color:chocolate"><strong>There was a problem</strong></span>
                                            <span style="color: chocolate">
                                                The number <span style="color:grey" id="override-phone">0</span> is not
                                                linked to <span style="color:chocolate" id="override-email"></span>
                                            </span>
                                            <span style="color:chocolate">
                                                Please contact the shcool's D.O.S / H.O.D Academics and request them to
                                                add your correct phone number to this account
                                            </span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row align-items-center py-2 px-2"
                                            style="border:1px solid chocolate;border-radius:10px;padding:0px !important"
                                            id="issue-password">
                                            <span style="color:chocolate;padding:10px" class="active-state" id="issue">
                                    ...
                                    <div class="form-group">
                                        <div class="row col-12 align-items-center py-2 px-2"
                                            style="border:1px solid green;border-radius:10px;" id="reset-logo">
                                    ...
                                    <div class="form-group d-flex justify-content-between">
                                        ...
                                        <a onclick="usernameRequest();" @if (!$errors->has('password'))
                                        ...
                                        <a onclick="passwordRequest();" @if ($errors->has('password'))
                                            class="pull-right text-success"
                                            @else
                                            class="pull-right text-success active-state"
                                            @endif
                                    ...
                                    <span for="newpassword" style="color: grey" id="newpasswordlabel">New
                                        Password</span>
                                    ...
                                    <span for="confirmpassword" style="color: grey" id="confirmpasswordlabel">Re-Type
                                        New Password</span>
                                    ...
                                    <div class="form-group mb-0 d-flex justify-content-end">
                                        <div class="col-md-12">
                                            <button type="button" id="continue" @if ($errors->has('password'))
                                    ...
                                    <div class="form-group mb-0 d-flex justify-content-end">
                                        <div class="col-md-12">
                                            <div id="verify" class="btn btn-block btn-success text-white active-state">
                                                <span class="ng-star-inserted">Verify</span>
                                                <img src="{{ asset('assets/gif/spinner.gif') }}" id="loadimg"
                                                    alt="Loading">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group mb-0 d-flex justify-content-end">
                                        <div class="col-md-12">
                                            <div id="signing" class="btn btn-block btn-success text-white active-state">
                                    ...
                                    <div class="form-group mb-0 d-flex justify-content-end">
                                        <div class="col-md-12">
                                            <button type="submit" onclick="sendDashboard()"
                                                @if($errors->has('password'))
                                                class="btn btn-block btn-success text-white"
                                                @else
                                                class="btn btn-block btn-success text-white active-state"
                    ...
                    <div id="register" role="tabpanel" aria-labelledby="register-tab"
                        ...
                        <div class="col-md-12 col-xs-12 mb-0 p-3 text-wrap"
                            ...
                            <span>
                                ...
                                {{ trans("local.or") }}
                                <strong><a target="_blank" style="text-decoration: none">
                                        info@zeraki.co.ke
                                    </a></strong>
                                {{ trans("local.soon") }}
                                <strong><a data-bs-toggle="tab" data-bs-target="#register" role="tab"
                                        class="text-primary" href="{{ route('login') }}">
                                        {{ trans("local.login") }}
                                    </a></strong>
                                {{ trans("local.already") }}
                            </span>
                ...
                <div class="col-lg-7 text-center">
                    <div class="section-title">
                        ...
                        <div class="mx-auto my-4">
                            <img src="/global_assets/images/landing/center-logo.png" alt="" class="img-fluid"
                                width="120px" />
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="service-item mb-4">
                        <div class="d-flex align-items-center">
                            <div class="mx-auto my-4">
                                <img src="/global_assets/images/landing/clock.png" alt="" class="img-fluid"
                                    width="60px" />
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="service-item mb-4">
                        <div class="d-flex align-items-center">
                            <div class="mx-auto my-4">
                                <img src="/global_assets/images/landing/intuitive.png" alt="" class="img-fluid"
                                    width="60px" />
                            </div>
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="service-item mb-4">
                        <div class="d-flex align-items-center">
                            <div class="mx-auto my-4">
                                <img src="/global_assets/images/landing/setting.png" alt="" class="img-fluid"
                                    width="60px" />
                            </div>
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="service-item mb-4">
                        <div class="d-flex align-items-center">
                            <div class="mx-auto my-4">
                                <img src="/global_assets/images/landing/training.png" alt="" class="img-fluid"
                                    width="60px" />
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="service-item mb-4">
                        <div class="d-flex align-items-center">
                            <div class="mx-auto my-4">
                                <img src="/global_assets/images/landing/round-clock.png" alt="" class="img-fluid"
                                    width="60px" />
                            </div>
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="service-item mb-4">
                        <div class="d-flex align-items-center">
                            <div class="mx-auto my-4">
                                <img src="/global_assets/images/landing/hosted.png" alt="" class="img-fluid"
                                    width="60px" />
                            </div>
                        </div>
                        <div class="content">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-4">
                    ...
                    <div class="row align-items-center">
                        <div class="testimonial-thumb">
                            <img src="/global_assets/images/landing/person1.png" class="rounded-circle" alt=""
                                width="70px" />
                        </div>
                        <div class="client-info col-8">
                            ...
                            <div class="rating-stars" style="width: 100%;">
                                <input type="radio" name="rating" id="rs0" checked /><label for="rs0"
                                    style="width:20px;height:20px;"></label>
                                <input type="radio" name="rating" id="rs1" /><label for="rs1"
                                    style="width:20px;height:20px;"></label>
                                <input type="radio" name="rating" id="rs2" /><label for="rs2"
                                    style="width:20px;height:20px;"></label>
                                <input type="radio" name="rating" id="rs3" /><label for="rs3"
                                    style="width:20px;height:20px;"></label>
                                <input type="radio" name="rating" id="rs4" /><label for="rs4"
                                    style="width:20px;height:20px;"></label>
                                <input type="radio" name="rating" id="rs5" /><label for="rs5"
                                    style="width:20px;height:20px;"></label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="row align-items-center">
                        <div class="testimonial-thumb">
                            <img src="/global_assets/images/landing/person2.png" alt="" class="rounded-circle"
                                width="80px" />
                        </div>
                        <div class="client-info col-8">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="row align-items-center">
                        <div class="testimonial-thumb">
                            <img src="/global_assets/images/landing/person3.png" alt="" class="rounded-circle"
                                width="80px" />
                        </div>
                        <div class="client-info col-8">
                ...
                <div class="col-lg-6">
                    <div class="appoinment-wrap">
                        <ul class="nav nav-tabs nav-fill">
                            <li class="nav-item">
                                <a href="#!" data-toggle="tab" class="nav-link" style="cursor: pointer">
                        ...
                        <div id="#" class="appoinment-form" method="post" action="#">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input name="contact_phone" id="contact_phone" type="text" class="form-control"
                                            placeholder="07## ### ###" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group-2 mb-4">
                                ...
                                <textarea name="contact_message" id="contact_message" class="form-control" rows="3"
                                    placeholder="Your Message here"></textarea>
                            </div>

                            <a class="btn btn-success btn-round-3" onclick="contactSupport();">
                                {{ trans("local.send") }}<i class="icofont-telegram ml-2"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-md-3 mr-auto col-sm-6">
                    <div class="widget mb-5 mb-lg-0">
                        <div class="logo mb-4">
                            <img src="/global_assets/images/landing/footer-logo.png" alt="" class="img-fluid"
                                width="103px;" />
                        </div>
                        <p>{{ trans("local.ltd") }}</p>
                        <p>{{ trans("local.po") }}</p>
