...
const showDataOn = (data) => {
    ...
    for (studentdata of data) {
        str +=
            ` <div class="row" style="font-family:icofont;border-left:solid 40px #41CAFF;border-radius:40px;margin-bottom:70px">
                                    <div class="col-12">
                                        <div class="row" style="padding-bottom:15px">
                                            <div class="col-3">
                                                <img src="{{asset('assets/images/school.png')}}" style="float:left;margin-left:30px"
                                                    width="120" height="120">
                                            </div>
                                            <div class="col-9">
                                                <p style="font-size:30px;text-align:right;margin-bottom:20px;color:#41CAFF">
                                                    {{$schoolname->school_name}}-{{$schoolname->school_postal}}
                                                </p>
                                                <p style="text-align:right;font-size:16px;line-height:0.8">
                                        ...
                                        <div class="col-12" style="margin-bottom:20px;padding:0px"><div style="background-color:#41CAFF;padding:7px"><p style="font-size:25px;color:white;margin-bottom:0px">Academic Report Form - Form 2 CAT 1 - (2023-Term 1)</p></div></div>
                                            <div class="col-6">
                                                <div class="row">
        ...
        str += ` </tbody>
                                            ...
                                            <div class="col-6" style="margin-bottom:40px">
                                                <div class="row">
                                                    ...
                                                    <div class="col-7">
                                                        <p>Scan to access your interactive student profile on zeraki Analytics.
                                                        Your Username:1225@birionihigh</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12" style="margin-top:20px;margin-bottom:40px">
