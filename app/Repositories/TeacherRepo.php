...
class TeacherRepo
{
    ...
    {
        $res = Teacher::orderBy('id', 'asc')->get();
        return count($res);
    }
    ...
    public function is_check_having_subject_teacher($teacher_id)
    {
        return ClassSubject::where('teacher_id', $teacher_id)->get();
    }

    public function is_check_having_class($teacher_id)
    {
        return MyClass::where('teacher_id', $teacher_id)->get();
    }

    public function is_check_having_form($teacher_id)
    {
        return Form::where('teacher_id', $teacher_id)->get();
    }
