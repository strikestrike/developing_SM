...
class ExamRepo
{
    ...
    public function getStreambyFormId($parameter)
    {
        return MyClass::where('form_id', $parameter)->with('class_subject.subject')->get();
    }

    public function getsubjects( $firstclassid ){
        return ClassSubject::where('my_class_id',$firstclassid)->with("subject")->get();
    }

    public function getStudentsbyFormId($id)
    {
        return Student::where('my_class_id',$id)->get();
    }

    public function getExambyFormId($parameter)
    {
        return ExamForm::where('form_id', $parameter)->with('exam')->orderBy('created_at', 'desc')->get();
    }
